...
codex1 = Codices.query.get(1)  # Recherche un enregistrement par sa clé prim. et l'assigne en tant que classe d'objet (<class '__main__.Codices'>)
...
oeuvres_Augustin = Oeuvres.query.filter(Oeuvres.auteur == 4).all() # Assigne l'enregistrement sous forme d'une liste (ici d'un seul item)
