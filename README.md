...
## API
Trois routes d'API ont été créées :
...
- `api/recherche-codex?q=MOTSCLES` permet d'effectuer une recherche dans la base selon un ou plusieurs mots-clés passés dans l'URL. La recherche se comporte comme la **recherche simple** de l'interface utilisateur.
