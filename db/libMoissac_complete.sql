...
INSERT INTO "unites_codico" ("id","descript","loc","date_pas_avant","date_pas_apres","date_circa", "code_id")
VALUES
       (1,'Parchemin. 154 ff., précédés et suivis d’une garde en parchemin. 180 x 123 mm (justif. 130 x 80 mm). Écriture minuscule caroline d’une main principale.',NULL,975,1000,0, 1),
       (2,'Parchemin.179 ff.350 × 230 mm.',NULL,1001,1100,0, 2);
