...
INSERT INTO "unites_codico" ("id","descript","loc_init","loc_init_v","loc_fin","loc_fin_v","date_pas_avant","date_pas_apres","code_id") VALUES (1,'Parchemin. 154 ff., précédés et suivis d’une garde en parchemin. 180 x 123 mm (justif. 130 x 80 mm). Écriture minuscule caroline d’une main principale.',NULL,NULL,NULL,NULL,975,1000,1),
 ...
 (6,'Parchemin (certains feuillets sont coupés), 77 ff., 310 x 215 mm (just. 230 x 160 mm). 10 cahiers : 1 cahier de 7 ff. (1-7 ; f. 7 monté), 3 cahiers de 8 ff. (8-31), 1 cahier de 9 ff. (32-40 ; le 10e f. est coupé), 4 cahiers de 8 ff. (41-72), 1 cahier de 5 ff. (73-77 ; montages multiples, présence de talons), précédés et suivis d''une garde de papier et de deux gardes de parchemin. Réclames. Signatures. Piqures.',NULL,NULL,NULL,NULL,1101,1150,3),
